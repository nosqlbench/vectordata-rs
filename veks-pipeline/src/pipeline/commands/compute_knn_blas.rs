    ...
    fn describe_options(&self) -> Vec<OptionDesc> {
        vec![
            OptionDesc { name: "base".into(), type_name: "Path".into(), required: true, default: None,
                description: "Base vectors file (fvec only)".into(), extended_description: None, role: OptionRole::Input },
            OptionDesc { name: "query".into(), type_name: "Path".into(), required: true, default: None,
                description: "Query vectors file (fvec only)".into(), extended_description: None, role: OptionRole::Input },
            OptionDesc { name: "indices".into(), type_name: "Path".into(), required: true, default: None,
                description: "Output neighbor indices (ivec)".into(), extended_description: None, role: OptionRole::Output },
            OptionDesc { name: "distances".into(), type_name: "Path".into(), required: false, default: None,
                description: "Output neighbor distances (fvec)".into(), extended_description: None, role: OptionRole::Output },
            OptionDesc { name: "neighbors".into(), type_name: "int".into(), required: true, default: None,
                description: "Number of nearest neighbors (k)".into(), extended_description: None, role: OptionRole::Config },
            OptionDesc { name: "metric".into(), type_name: "enum".into(), required: false,
                default: Some("L2".into()),
                description: "Distance metric: L2, DOT_PRODUCT, COSINE, IP".into(), extended_description: None, role: OptionRole::Config },
